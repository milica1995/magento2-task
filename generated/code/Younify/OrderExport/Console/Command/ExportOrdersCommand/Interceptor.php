<?php
namespace Younify\OrderExport\Console\Command\ExportOrdersCommand;

/**
 * Interceptor class for @see \Younify\OrderExport\Console\Command\ExportOrdersCommand
 */
class Interceptor extends \Younify\OrderExport\Console\Command\ExportOrdersCommand implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Younify\OrderExport\Model\ExportOrders $exportOrders)
    {
        $this->___init();
        parent::__construct($exportOrders);
    }
